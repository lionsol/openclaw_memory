...
# OpenClaw 记忆系统 v1.0 架构与开发文档 (SQLite 增强版)

## 1. 架构核心哲学 (Design Philosophy)

本系统以agentmemory和graph memory为基础，采用“存算分离、惰性衰减、实证强化”体系，并在工程细节上加固了边缘防护与可观测性。
...
| 版本 | 日期 | 变更说明 |
|------|------|----------|
| v1.1 | 2026-05-15 | 整合审查建议：防御性NULL处理、子图置信度字段、弱引用冷启动、归档二次确认、可配置参数、诊断日志 |
